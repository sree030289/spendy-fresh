...
const tourSteps: TourStep[] = [
  ...
  {
    id: 'ai-analytics',
    title: 'AI Analytics & Smart Features 🤖',
    quote: 'Save Money While You Split.',
    description: 'Get AI-powered spending insights, scan receipts with smart recognition, and track your expenses with intelligent categorization.',
    icon: 'analytics',
    color: '#667eea',
    gradient: ['#667eea', '#764ba2'],
    animation: 'scale',
    ...
    features: ['AI analytics', 'Receipt scanning', 'Smart categorization', 'Expense insights'],
  },
];
