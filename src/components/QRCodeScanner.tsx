...
export default function QRCodeScanner({ visible, onQRCodeScanned, onClose }: QRCodeScannerProps) {
  ...
  const handleBarCodeScanned = ({ type, data }: { type: string; data: string }) => {
    if (!scanned) {
      ...
      // Validate that it's a Spendy QR code
      if (data.startsWith('spendy://qr') || data.includes('spendy')) {
        onQRCodeScanned(data);
      } else {
        Alert.alert(
          'Invalid QR Code',
          'This is not a Spendy QR code. Please scan a QR code generated by Spendy.',
          [
            {
              text: 'Try Again',
